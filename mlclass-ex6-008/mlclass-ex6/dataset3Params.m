...
%there are 64 possibilities for each C and sigma. So results is a 64 * 3 matrix which stores values in rows as [C_test, sigma_test, prediction_error] foreach case        
